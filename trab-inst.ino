...
//----- Variaveis de Controle Dimmer
#define pinZC  2
#define pinDIM 4

#define temperaturaIdeal 36
#define temperaturaMinima 20.5
#define temperaturaMaxima 39
...
void msgInterpreter() {//---  Interpretador de mensagens ---
    ...
    msgIndex = inputString.indexOf(';'); //índice de Aum caracter de fim de mensagem
